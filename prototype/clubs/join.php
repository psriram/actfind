...
?>
 ...
 <script src="https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places"></script>
	...
	<div class="row text-center">
     ...
     <hr />
    <div class="row">
        <form role="form" method="post" name="formJoin" id="formJoin" action="/actfind/prototype/clubs/saveclub">
            <div class="col-lg-6">
                ...
                <div id="locfindgroup" class="form-group">
                    ...
                    <div class="input-group locationField">
                       <input id="autocomplete1" name="autocomplete1" placeholder="Enter Location 1"
                                                     onFocus="geolocate()" type="text" class="form-control" required autocomplete="off"></input>
            ...
            <input type="hidden" name="locationCounter" id="locationCounter" value="1">
            <input type="hidden" name="classCounter" id="classCounter" value="1">
            <input type="hidden" name="scheduleCounter" id="scheduleCounter" value="1">
        </form>
